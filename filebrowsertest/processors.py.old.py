...
class PointDto:
        ...
        def __mul__(self, s: float) -> "PointDto":
                return PointDto(x=self.x * s, y=self.y * s)

        def __add__(self, other: "PointDto") -> "PointDto":
                return PointDto(x=self.x + other.x, y=self.y + other.y)

        def __sub__(self, other: "PointDto") -> "PointDto":
                return PointDto(x=self.x - other.x, y=self.y - other.y)
    ...
    def set_shape_on_left_click(self, event):
        ...
        # Stop processing clicks
            ...
            if(self.DEBUG_LEVEL>2):
                ...
                imagesh=ImageOps.crop(self.pil_img, self.rect_hough_borders)
